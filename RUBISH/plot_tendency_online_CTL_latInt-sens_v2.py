...
exp     = ["Global (a)","Atlantic (b)","Indo-Pacific (c)","Pacific (d)","Indian (e)"]
...
ax.plot(unresolved_glb[:],    marker='*',markersize=6,color='k',linewidth=.5,markerfacecolor=colors[7],label=labels[7])
...
ax.plot(unresolved_atl[:],    marker='*',markersize=6,color='k',linewidth=.5,markerfacecolor=colors[7],label=labels[7])
...
ax.plot(advection_ipa[:],     marker='o',markersize=6,color='k',linewidth=.5,markerfacecolor=colors[1],label=labels[1])
...
ax.plot(vdiff_ipa[:],         marker='o',markersize=6,color='k',linewidth=.5,markerfacecolor=colors[5],label=labels[5])
ax.plot(super_residual_ipa[:],marker='o',markersize=6,color='k',linewidth=.5,markerfacecolor=colors[6],label=labels[6])
ax.plot(unresolved_ipa[:],    marker='*',markersize=6,color='k',linewidth=.5,markerfacecolor=colors[7],label=labels[7])
...
ax.plot(unresolved_pac[:],    marker='*',markersize=6,color='k',linewidth=.5,markerfacecolor=colors[7],label=labels[7])
...
#plt.show()
plt.savefig('tendency_online_CTL_latInt-sens_v17nov.png',transparent = False, bbox_inches='tight',dpi=300)
