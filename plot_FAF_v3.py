...
plt.title('(a) faf-stress',fontsize=16)
...
ax5 = plt.subplot2grid((3,5),(1,0),colspan=4)
...
plt.title('(b) faf-heat',fontsize=16)
plt.yticks([])#-80,-60,-40,-20,0,20,40,60,80],['80S','60S','40S','20S','0','20N','40N','60N','80N'],fontsize=11)
plt.xticks([])#,[],fontsize=12)
...
#plt.show()
plt.savefig('FAF_anomalies_150423.png',transparent = True, bbox_inches='tight',dpi=600)
