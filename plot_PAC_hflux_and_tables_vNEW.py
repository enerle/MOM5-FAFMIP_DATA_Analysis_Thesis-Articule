...
filename = ['MOC_RHO_PAC_hflux_FAFSTRESS.nc','MOC_RHO_PAC_hflux_FAFWATER.nc','MOC_RHO_PAC_hflux_FAFHEAT.nc','MOC_RHO_PAC_hflux_FAFALL.nc','MOC_RHO_PAC_hflux_flux-only.nc']
...
for i in range(len(filename)):
    ...
    file = nc.Dataset(fn)
##NORTHERN HEMISPHERE
    trans_upp1_int_north[i] =file.variables['TRANS0000_INT_NORTH'][:]*yt
    trans_upp2_int_north[i] =file.variables['TRANS0100_INT_NORTH'][:]*yt
    trans_upp3_int_north[i] =file.variables['TRANS0201_INT_NORTH'][:]*yt
    trans_itm1_int_north[i] =file.variables['TRANS0302_INT_NORTH'][:]*yt
    trans_itm2_int_north[i] =file.variables['TRANS0403_INT_NORTH'][:]*yt
    trans_itm3_int_north[i] =file.variables['TRANS0504_INT_NORTH'][:]*yt
    trans_dpp1_int_north[i] =file.variables['TRANS0605_INT_NORTH'][:]*yt
    trans_dpp2_int_north[i] =file.variables['TRANS0706_INT_NORTH'][:]*yt
    trans_dpp3_int_north[i] =file.variables['TRANS0807_INT_NORTH'][:]*yt
    trans_btt1_int_north[i] =file.variables['TRANS0908_INT_NORTH'][:]*yt
    trans_vsum_int_north[i] =file.variables['TRANS0009_INT_NORTH'][:]*yt

    trans_upp1_wbc_north[i] =file.variables['TRANS0000_WBC_NORTH'][:]*yt
    trans_upp2_wbc_north[i] =file.variables['TRANS0100_WBC_NORTH'][:]*yt
    trans_upp3_wbc_north[i] =file.variables['TRANS0201_WBC_NORTH'][:]*yt
    trans_itm1_wbc_north[i] =file.variables['TRANS0302_WBC_NORTH'][:]*yt
    trans_itm2_wbc_north[i] =file.variables['TRANS0403_WBC_NORTH'][:]*yt
    trans_itm3_wbc_north[i] =file.variables['TRANS0504_WBC_NORTH'][:]*yt
    trans_dpp1_wbc_north[i] =file.variables['TRANS0605_WBC_NORTH'][:]*yt
    trans_dpp2_wbc_north[i] =file.variables['TRANS0706_WBC_NORTH'][:]*yt
    trans_dpp3_wbc_north[i] =file.variables['TRANS0807_WBC_NORTH'][:]*yt
    trans_btt1_wbc_north[i] =file.variables['TRANS0908_WBC_NORTH'][:]*yt
    trans_vsum_wbc_north[i] =file.variables['TRANS0009_WBC_NORTH'][:]*yt

##SOUTHERN HEMISPHERE
    trans_upp1_int_south[i] =file.variables['TRANS0000_INT_SOUTH'][:]*yt
    trans_upp2_int_south[i] =file.variables['TRANS0100_INT_SOUTH'][:]*yt
    trans_upp3_int_south[i] =file.variables['TRANS0201_INT_SOUTH'][:]*yt
    trans_itm1_int_south[i] =file.variables['TRANS0302_INT_SOUTH'][:]*yt
    trans_itm2_int_south[i] =file.variables['TRANS0403_INT_SOUTH'][:]*yt
    trans_itm3_int_south[i] =file.variables['TRANS0504_INT_SOUTH'][:]*yt
    trans_dpp1_int_south[i] =file.variables['TRANS0605_INT_SOUTH'][:]*yt
    trans_dpp2_int_south[i] =file.variables['TRANS0706_INT_SOUTH'][:]*yt
    trans_dpp3_int_south[i] =file.variables['TRANS0807_INT_SOUTH'][:]*yt
    trans_btt1_int_south[i] =file.variables['TRANS0908_INT_SOUTH'][:]*yt
    trans_vsum_int_south[i] =file.variables['TRANS0009_INT_SOUTH'][:]*yt

    trans_upp1_wbc_south[i] =file.variables['TRANS0000_WBC_SOUTH'][:]*yt
    trans_upp2_wbc_south[i] =file.variables['TRANS0100_WBC_SOUTH'][:]*yt
    trans_upp3_wbc_south[i] =file.variables['TRANS0201_WBC_SOUTH'][:]*yt
    trans_itm1_wbc_south[i] =file.variables['TRANS0302_WBC_SOUTH'][:]*yt
    trans_itm2_wbc_south[i] =file.variables['TRANS0403_WBC_SOUTH'][:]*yt
    trans_itm3_wbc_south[i] =file.variables['TRANS0504_WBC_SOUTH'][:]*yt
    trans_dpp1_wbc_south[i] =file.variables['TRANS0605_WBC_SOUTH'][:]*yt
    trans_dpp2_wbc_south[i] =file.variables['TRANS0706_WBC_SOUTH'][:]*yt
    trans_dpp3_wbc_south[i] =file.variables['TRANS0807_WBC_SOUTH'][:]*yt
    trans_btt1_wbc_south[i] =file.variables['TRANS0908_WBC_SOUTH'][:]*yt
    trans_vsum_wbc_south[i] =file.variables['TRANS0009_WBC_SOUTH'][:]*yt
...
#correction for surface cell mass imbalanc
#since we considere any mass imbalance take place below the ekman layer and inside the stc, so in the interior ocean
# we estimated the net transport as wbc-int=net 
#in other words, we §forced mass balance bellow ekman layer (equatorward+polewarw=0)
#to note we do not know what the imbalance is, but it is argually imb=ITF/BS
