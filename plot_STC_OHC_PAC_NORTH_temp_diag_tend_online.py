...
#plt.show()
#plt.savefig('STC_OHC_PAC_NORTH_diag_tend_online.png',transparent = False, bbox_inches='tight',dpi=300)
...
plt.savefig('STC_OHC_PAC_NORTH_diag_tend_online_CTL_FAFMIP.png',transparent = False, bbox_inches='tight',dpi=300)
