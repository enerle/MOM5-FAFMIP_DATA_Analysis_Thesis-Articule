...
exp            = ["(b) faf-stress","(c) faf-water","(d) faf-heat","(a) Control"]
filename       = ['STC_temptend_FAFSTRESS_SOUTH_PAC.nc','STC_temptend_FAFWATER_SOUTH_PAC.nc','STC_temptend_FAFHEAT_SOUTH_PAC.nc','STC_temptend_flux-only_SOUTH_PAC.nc']
...
for i in range(len(exp)-1):
    ...
    ax.plot(0.6,advection[i]-advection[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1]) #advection
    ax.plot(0.6,eddy[i]-eddy[-1],                    marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[2]) #eddy
    ax.plot(0.6,residual[i]-residual[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[3]) #residual
    ax.plot(1.4,isopycnal_mix[i]-isopycnal_mix[-1],  marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[4]) #isopycnal
    ax.plot(1.0,vdiff[i]-vdiff[-1],                  marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5]) #diapycnal 
    ax.plot(1.0,super_residual[i]-super_residual[-1],marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6]) #superresidual
    
    ax.plot(3.0,temptend_stc[i]-temptend_stc[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[0]) 
    ax.plot(2.6,advection_stc[i]-advection_stc[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1]) 
    ax.plot(2.6,eddy_stc[i]-eddy_stc[-1],                    marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[2]) 
    ax.plot(2.6,residual_stc[i]-residual_stc[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[3])
    ax.plot(3.4,isopycnal_mix_stc[i]-isopycnal_mix_stc[-1],  marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[4]) 
    ax.plot(3.0,vdiff_stc[i]-vdiff_stc[-1],                  marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5]) 
    ax.plot(3.0,super_residual_stc[i]-super_residual_stc[-1],marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6]) 
    ...
    ax.plot(4.6,advection_int[i]-advection_int[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1],label=labels[1])
    ax.plot(4.6,eddy_int[i]-eddy_int[-1],                    marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[2],label=labels[2])
    ax.plot(4.6,residual_int[i]-residual_int[-1],            marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[3],label=labels[3])
    ax.plot(5.4,isopycnal_mix_int[i]-isopycnal_mix_int[-1],  marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[4],label=labels[4])
    ax.plot(5.0,vdiff_int[i]-vdiff_int[-1],                  marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5],label=labels[5])
    ax.plot(5.0,super_residual_int[i]-super_residual_int[-1],marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6],label=labels[6])
...
ax.plot(0.6,advection[-1],         marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1]) #advection
ax.plot(0.6,eddy[-1],              marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[2]) #eddy
ax.plot(0.6,residual[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[3]) #residual
ax.plot(1.4,isopycnal_mix[-1],     marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[4]) #isopycnal
ax.plot(1.0,vdiff[-1],             marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5]) #diapycnal 
ax.plot(1.0,super_residual[-1],    marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6]) #superresidual

ax.plot(3.0,temptend_stc[-1],      marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[0]) 
ax.plot(2.6,advection_stc[-1],     marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1])
ax.plot(2.6,eddy_stc[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[2])
ax.plot(2.6,residual_stc[-1],      marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[3])
ax.plot(3.4,isopycnal_mix_stc[-1], marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[4])
ax.plot(3.0,vdiff_stc[-1],         marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5])
ax.plot(3.0,super_residual_stc[-1],marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6]) 

ax.plot(5.0,temptend_int[-1],      marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[0],label=labels[0])
ax.plot(4.6,advection_int[-1],     marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[1],label=labels[1])
ax.plot(4.6,eddy_int[-1],          marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[2],label=labels[2])
ax.plot(4.6,residual_int[-1],      marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[3],label=labels[3])
ax.plot(5.4,isopycnal_mix_int[-1], marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[4],label=labels[4])
ax.plot(5.0,vdiff_int[-1],         marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[5],label=labels[5])
ax.plot(5.0,super_residual_int[-1],marker='o',markersize=8,color='k',linewidth=0,markerfacecolor=colors[6],label=labels[6])
...
#plt.show()
plt.savefig('STC_OHC_PAC_SOUTH_diag_tend_online_CTL_FAFMIP.png',transparent = False, bbox_inches='tight',dpi=300)
