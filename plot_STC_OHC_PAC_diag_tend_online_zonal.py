...
tend_name = ["NET","ADV","EDDY","ISO","vDIFF","srADV"]
...
for i in range(len(exp)-1): 
    ...
    fig.suptitle(exp[i], fontsize=15)
    ...
    cs  = plt.pcolormesh(lat2[i],depth2[i],temptend[i][:,:]-temptend[-1][:,:],shading='gouraud',cmap=cmap2)#'gouraud'
    plt.clim(kmin,kmax)
...
ax = fig.add_subplot(2,3,1)###
cs  = plt.pcolormesh(lat2[-1],depth2[-1],temptend[-1][:,:],shading='gouraud',cmap=cmap2)#'gouraud'
plt.clim(kmin,kmax)
