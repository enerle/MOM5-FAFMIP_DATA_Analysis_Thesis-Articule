...
filename = ["pot_rho_0_zonalmean_FAFSTRESS.nc","pot_rho_0_zonalmean_FAFWATER.nc","pot_rho_0_zonalmean_FAFHEAT.nc","pot_rho_0_zonalmean_FAFALL.nc","pot_rho_0_zonalmean_flux-only.nc"]
...
plt.show()
#plt.savefig('potrho0_zonalmean.png',transparent = True, bbox_inches='tight',dpi=600)
