...
filename = ["heat_budget_FAFSTRESS_vertical_GLB.nc","heat_budget_FAFWATER_vertical_GLB.nc","heat_budget_FAFHEAT_vertical_GLB.nc","heat_budget_flux-only_vertical_GLB.nc"]
...
ax.axis([-10,50,-5500,0])
plt.axvline(x=0.0,color='k',linestyle='--',linewidth=2)
plt.yticks([0,-1000,-2000,-3000,-4000,-5000],[])

#plt.show()
plt.savefig('tendency_online_vertical_FAFHEAT_GLB.png',transparent = False, bbox_inches='tight',dpi=300)
