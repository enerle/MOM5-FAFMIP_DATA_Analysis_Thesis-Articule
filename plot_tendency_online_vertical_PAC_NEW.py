...
filename = ["heat_budget_FAFSTRESS_vertical_PAC.nc","heat_budget_FAFWATER_vertical_PAC.nc","heat_budget_FAFHEAT_vertical_PAC.nc","heat_budget_flux-only_vertical_PAC.nc"]
...
#plt.title('Total ocean heat budget (e)',style='normal',fontsize=14)
...
#plt.title('Super-residual framework (f)',style='normal',fontsize=14)
...
#plt.show()
plt.savefig('tendency_online_vertical_FAFHEAT_PAC.png',transparent = False, bbox_inches='tight',dpi=300)
